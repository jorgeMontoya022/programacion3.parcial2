...
public class ArchivoUtil {
    public static List<String> leerArchivoMaterias(String rutaArchivo) throws IOException {
    ...
    public static List<String> leerArchivoEstudiantes(String rutaArchivo) throws IOException {
        List<String> contenido = new ArrayList<>();
        try (BufferedReader bfr = new BufferedReader(new FileReader(rutaArchivo))) {
            String linea;
            while ((linea = bfr.readLine()) != null) {
    ...
    public static void guardarArchivoAsignacionMaterias(String rutaArchivo, String contenido, boolean append) throws IOException {
